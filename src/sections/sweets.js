  ...
  <div class="container fade-in-section">
    <div class="ornate-border">
      ...
      <div class="filter-strip flex justify-center font-display text-gold">
        ...
        <button class="filter-btn" data-filter="ladoos">LADOOS</button>
        <span class="divider">|</span>
      ...
      <div class="sweets-grid">
        ...
        <div class="sweet-card polaroid-style hover-glow" data-category="ladoos">
          <div class="card-img">
            <img src="https://images.pexels.com/photos/2474661/pexels-photo-2474661.jpeg?auto=compress&cs=tinysrgb&w=600" alt="Motichoor Ladoo">
          </div>
        ...
        <div class="sweet-card polaroid-style hover-glow" data-category="ladoos">
          <div class="card-img">
            <img src="https://images.pexels.com/photos/4033148/pexels-photo-4033148.jpeg?auto=compress&cs=tinysrgb&w=600" alt="Besan Ladoo">
          </div>
          <div class="card-content text-center">
        ...
        <div class="sweet-card polaroid-style hover-glow" data-category="ladoos">
          <div class="card-img">
            <img src="https://images.pexels.com/photos/13063302/pexels-photo-13063302.jpeg?auto=compress&cs=tinysrgb&w=600" alt="Boondi Ladoo">
          </div>
          <div class="card-content text-center">
        ...
        <div class="sweet-card polaroid-style hover-glow" data-category="barfis">
          <div class="card-img">
            <img src="https://images.pexels.com/photos/2474661/pexels-photo-2474661.jpeg?auto=compress&cs=tinysrgb&w=600" alt="Kaju Katli">
          </div>
          <div class="card-content text-center">
        ...
        <div class="sweet-card polaroid-style hover-glow" data-category="barfis">
          <div class="card-img">
            <img src="https://images.pexels.com/photos/4033148/pexels-photo-4033148.jpeg?auto=compress&cs=tinysrgb&w=600" alt="Pista Barfi">
          </div>
          <div class="card-content text-center">
        ...
        <div class="sweet-card polaroid-style hover-glow" data-category="barfis">
          <div class="card-img">
            <img src="https://images.pexels.com/photos/13063302/pexels-photo-13063302.jpeg?auto=compress&cs=tinysrgb&w=600" alt="Coconut Barfi">
          </div>
          <div class="card-content text-center">
        ...
        <div class="sweet-card polaroid-style hover-glow" data-category="halwa">
          <div class="card-img">
            <img src="https://images.pexels.com/photos/2474661/pexels-photo-2474661.jpeg?auto=compress&cs=tinysrgb&w=600" alt="Ghee Mysore Pak">
          </div>
          <div class="card-content text-center">
        ...
        <div class="sweet-card polaroid-style hover-glow" data-category="halwa">
          <div class="card-img">
            <img src="https://images.pexels.com/photos/4033148/pexels-photo-4033148.jpeg?auto=compress&cs=tinysrgb&w=600" alt="Badam Halwa">
          </div>
          <div class="card-content text-center">
        ...
        <div class="sweet-card polaroid-style hover-glow" data-category="halwa">
          <div class="card-img">
            <img src="https://images.pexels.com/photos/13063302/pexels-photo-13063302.jpeg?auto=compress&cs=tinysrgb&w=600" alt="Wheat Halwa">
          </div>
          <div class="card-content text-center">
        ...
        <div class="sweet-card polaroid-style hover-glow" data-category="snacks">
          <div class="card-img">
            <img src="https://images.pexels.com/photos/2474661/pexels-photo-2474661.jpeg?auto=compress&cs=tinysrgb&w=600" alt="Madras Mixture">
          </div>
          <div class="card-content text-center">
        ...
        <div class="sweet-card polaroid-style hover-glow" data-category="snacks">
          <div class="card-img">
            <img src="https://images.pexels.com/photos/4033148/pexels-photo-4033148.jpeg?auto=compress&cs=tinysrgb&w=600" alt="Murukku">
          </div>
          <div class="card-content text-center">
        ...
        <div class="sweet-card polaroid-style hover-glow" data-category="snacks">
          <div class="card-img">
            <img src="https://images.pexels.com/photos/13063302/pexels-photo-13063302.jpeg?auto=compress&cs=tinysrgb&w=600" alt="Ribbon Pakoda">
          </div>
          <div class="card-content text-center">
        ...
        <div class="sweet-card polaroid-style hover-glow" data-category="seasonal">
          <div class="card-img">
            <img src="https://images.pexels.com/photos/2474661/pexels-photo-2474661.jpeg?auto=compress&cs=tinysrgb&w=600" alt="Mini Jangiri">
          </div>
          <div class="card-content text-center">
        ...
        <div class="sweet-card polaroid-style hover-glow" data-category="seasonal">
          <div class="card-img">
            <img src="https://images.pexels.com/photos/4033148/pexels-photo-4033148.jpeg?auto=compress&cs=tinysrgb&w=600" alt="Sweet Somas">
          </div>
          <div class="card-content text-center">
        ...
        <div class="sweet-card polaroid-style hover-glow" data-category="seasonal">
          <div class="card-img">
            <img src="https://images.pexels.com/photos/13063302/pexels-photo-13063302.jpeg?auto=compress&cs=tinysrgb&w=600" alt="Athirasam">
          </div>
          <div class="card-content text-center">
